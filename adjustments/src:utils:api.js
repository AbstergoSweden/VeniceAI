 ...
 * @param {object} data - The data to send in the body of the request. If null, performs a GET request.
 * @param {object} config - Configuration object.
 * @param {string[]} config.API_KEYS - Array of available API keys for rotation.
 * @param {number} [initialKeyIndex=0] - The index of the API key to start with.
 * @param {boolean} [isBinary=false] - Whether the expected response is binary data (Blob/ArrayBuffer).
